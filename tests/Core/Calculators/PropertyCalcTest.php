...
class PropertyCalcTest extends TestCase
{
    ...
    public function testProduct(): void
    {
        ...
        $prop3 = PropertyCalc::multiple($prop1, $prop2);
    ...
    public function testProductSimple(): void
    {
        ...
        $this->assertSame(1000, PropertyCalc::multiple($prop1, $prop2, $prop3));
    }
    ...
    public function testProductCombinations(): void
    {
        ...
        $result = PropertyCalc::multiple($prop1, $prop2, $prop3);
